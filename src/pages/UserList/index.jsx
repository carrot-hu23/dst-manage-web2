        ...
        const columns2 = [
            ...
            },
            {
                ...
                render: (_, record) => [
                    // eslint-disable-next-line react/jsx-key
                    (<div>
                        <Switch checked={record.allowAddLevel} checkedChildren="开启" unCheckedChildren="关闭"
                                onChange={(v) => {
                                    const data = {
                                        ID: record.ID,
                                        allowAddLevel: v,
            ...
            },
            {
                ...
                render: (_, record) => [
                    // eslint-disable-next-line react/jsx-key
                    (<div>
                        <Switch checked={record.allowEditingServerIni} checkedChildren="开启" unCheckedChildren="关闭"
                                onChange={(v) => {
                                    const data = {
                                        ID: record.ID,
