...
exports.default = (function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsxs)("div", { className: "text-base font-medium pb-2", children: ["\u5C42\u6570: ", Object.keys(secondaries).length] }), (0, jsx_runtime_1.jsx)("div", { className: 'scrollbar', style: {
                    height: 400,
                    overflowY: 'auto',
                }, children: Object.keys(secondaries).map(function (key) { return ((0, jsx_runtime_1.jsxs)("div", { children: [(0, jsx_runtime_1.jsxs)(antd_1.Card, { bordered: false, style: theme !== 'dark' ? {
