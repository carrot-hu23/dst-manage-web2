...
var Recovery_1 = __importDefault(require("../AutoGameDown/Recovery"));
exports.default = (function () {
    ...
    (0, react_1.useEffect)(function () {
        setLoading(true);
        (0, autoCheckApi_1.autoCheck2Api)(cluster, "UPDATE_GAME")
            .then(function (resp) {
            if (resp.code === 200) {
    ...
    return ((0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Skeleton, { loading: loading, active: true, children: (0, jsx_runtime_1.jsx)(antd_1.Tabs, { defaultActiveKey: "1", size: autoChecks.length, items: autoChecks.map(function (autoCheck, index) {
                    return {
                        label: "游戏更新",
                        key: index,
                        children: (0, jsx_runtime_1.jsx)(Recovery_1.default, { isGameUpdate: true, isMod: true, autoCheck: autoCheck }, index),
                    };
                }) }) }) }));
});
