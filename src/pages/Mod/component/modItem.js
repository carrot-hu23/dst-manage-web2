...
function subscribeMod(modid, modList, setModList, setStartLoading) {
    ...
    (0, modApi_1.getModInfo)("", modid).then(function (data) {
        console.log(data.data);
        if (data.code !== 200) {
            antd_1.message.error("订阅失败，此模组可能下架了", data.msg);
        }
        else {
            ...
            antd_1.message.success("\u8BA2\u9605 ".concat(modid, " \u6210\u529F"));
        }
    }).catch(function (error) {
        antd_1.message.success("\u83B7\u53D6 ".concat(modid, " \u5931\u8D25"));
    });
}
    ...
    return (0, jsx_runtime_1.jsx)(antd_1.Spin, { spinning: startLoading, tip: "正在订阅模组", children: (0, jsx_runtime_1.jsxs)(antd_1.Card, { className: 'mod', style: { margin: ' 0 0 16px', backgroundColor: ((_a = props === null || props === void 0 ? void 0 : props.mod) === null || _a === void 0 ? void 0 : _a.update) ? "#583D23" : "" }, children: [(0, jsx_runtime_1.jsx)(antd_1.Row, { onClick: function () {
                        props.changeMod(props === null || props === void 0 ? void 0 : props.mod);
                                                ...
                                                whiteSpace: 'nowrap'
                                                    ...
                                                    (0, jsx_runtime_1.jsx)(antd_1.Switch, { checkedChildren: t('open'), unCheckedChildren: t('close'), defaultChecked: (_g = props === null || props === void 0 ? void 0 : props.mod) === null || _g === void 0 ? void 0 : _g.enable, onChange: function () {
                                                            var _a;
                                                            props.changeEnable((_a = props === null || props === void 0 ? void 0 : props.mod) === null || _a === void 0 ? void 0 : _a.modid);
                                                        } }), ((_h = props === null || props === void 0 ? void 0 : props.mod) === null || _h === void 0 ? void 0 : _h.modid) !== "client_mods_disabled" && (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: (0, jsx_runtime_1.jsx)(antd_1.Popconfirm, { title: t('delete this mod'), okText: "Yes", cancelText: "No", onConfirm: function () {
                                                            (0, modApi_1.deleteModInfo)(cluster, mod.modid)
                                                                .then(function (resp) {
                                                                if (resp.code === 200) {
                                                                    antd_1.message.success("删除模组成功");
                                                                    removeMod(mod.modid);
                                                                }
                                                            });
                                                        }, children: (0, jsx_runtime_1.jsx)(antd_1.Button, { type: "text", danger: true, onClick: function () {
                                                                setMod(props.mod);
                                                            }, children: t('Delete') }) }) }), ((_j = props === null || props === void 0 ? void 0 : props.mod) === null || _j === void 0 ? void 0 : _j.update) && (0, jsx_runtime_1.jsx)("span", { children: t('update this mod') })] })] })] }) }) }), (0, jsx_runtime_1.jsx)(antd_1.Row, { children: ((_k = props === null || props === void 0 ? void 0 : props.mod) === null || _k === void 0 ? void 0 : _k.installed) === false && (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(antd_1.Col, { flex: "64px", children: (0, jsx_runtime_1.jsx)("img", { alt: "example", src: (_l = props === null || props === void 0 ? void 0 : props.mod) === null || _l === void 0 ? void 0 : _l.img }) }), (0, jsx_runtime_1.jsxs)(antd_1.Col, { flex: "auto", style: { paddingLeft: '16px' }, children: [(0, jsx_runtime_1.jsx)(antd_1.Row, { children: (0, jsx_runtime_1.jsx)(antd_1.Col, { span: 24, children: (0, jsx_runtime_1.jsx)("span", { style: {
                                                    fontSize: '16px'
                                            ...
                                            marginTop: '12px'
                                        }, children: [(0, jsx_runtime_1.jsx)(antd_1.Col, { span: 12 }), (0, jsx_runtime_1.jsx)(antd_1.Col, { span: 24, children: (0, jsx_runtime_1.jsx)(antd_1.Popconfirm, { title: t('install this mod'), okText: "Yes", cancelText: "No", onConfirm: function () {
                                                        var _a;
                                                        subscribeMod((_a = props === null || props === void 0 ? void 0 : props.mod) === null || _a === void 0 ? void 0 : _a.modid, modList, setModList, setStartLoading);
